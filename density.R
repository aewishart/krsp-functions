...
rm(ag_core_may_census, area, census_1, census_2, census_all, connection_1, core_may_census_all, ll2_core_may_census, suchjokl_core_may_census, grid, selected_grids, selected_grids2)
